...
namespace vpsAPI.Migrations
{
    ...
    [Migration("20230111114301_lastmigration")]
            ...
            modelBuilder.Entity("vpsAPI.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DepartmentID = 1,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2023, 1, 11, 16, 43, 1, 53, DateTimeKind.Local).AddTicks(8501),
                        ...
                        new
                        {
                            DepartmentID = 2,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2023, 1, 11, 16, 43, 1, 53, DateTimeKind.Local).AddTicks(8514),
                        ...
                        new
                        {
                            DepartmentID = 3,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2023, 1, 11, 16, 43, 1, 53, DateTimeKind.Local).AddTicks(8516),
