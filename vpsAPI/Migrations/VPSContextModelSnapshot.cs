...
namespace vpsAPI.Migrations
{
    ...
    partial class VPSContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("vpsAPI.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DepartmentID = 1,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2023, 1, 11, 17, 44, 38, 490, DateTimeKind.Local).AddTicks(3921),
                        ...
                        new
                        {
                            DepartmentID = 2,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2023, 1, 11, 17, 44, 38, 490, DateTimeKind.Local).AddTicks(3940),
                        ...
                        new
                        {
                            DepartmentID = 3,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2023, 1, 11, 17, 44, 38, 490, DateTimeKind.Local).AddTicks(3944),
